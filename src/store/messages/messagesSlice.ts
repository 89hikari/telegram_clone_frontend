...
export const messagesSlice = createSlice({
  ...
  reducers: {
    catchMessageFromSocket: (state, action) => {
      ...
      const sidebarIndex = state.sidebar.findIndex(
        (elem) =>
      ...
      state.sidebar = [
        {
          ...
          receiverId: action.payload.receiverId,
          senderId: action.payload.senderId,
          sender: sidebarElem?.sender?.id
            ? sidebarElem.sender
            : {
                id: NaN,
                name: "",
              },
          receiver: sidebarElem?.receiver?.id
            ? sidebarElem.receiver
            : {
                id: NaN,
                name: "",
              },
...
export const { catchMessageFromSocket, catchNonExistendMessageFromSocket } =
